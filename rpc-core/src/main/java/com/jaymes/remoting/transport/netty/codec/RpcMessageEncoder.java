...
public class RpcMessageEncoder extends MessageToByteEncoder<RpcMessage> {
    ...
    @Override
    protected void encode(ChannelHandlerContext ctx, RpcMessage rpcMessage,
        ByteBuf out) {
        try {
            ...
            if (messageType != RpcConstants.HEARTBEAT_REQUEST_TYPE
                ...
                String codecName = SerializationTypeEnum
                    .getName(rpcMessage.getCodec());
                ...
                // compress the bytes
                String compressName = CompressTypeEnum
                    .getName(rpcMessage.getCompress());
            ...
            out.writerIndex(
                writeIndex - fullLength + RpcConstants.MAGIC_NUMBER.length + 1);
