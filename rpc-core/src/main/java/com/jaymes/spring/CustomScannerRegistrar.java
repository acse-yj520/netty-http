...
public class CustomScannerRegistrar implements ImportBeanDefinitionRegistrar,
  ...
  private static final String SPRING_BEAN_BASE_PACKAGE = "com.jaymes.spring";
  ...
  public void registerBeanDefinitions(AnnotationMetadata annotationMetadata,
    ...
    if (rpcScanAnnotationAttributes != null) {
      ...
      rpcScanBasePackages = rpcScanAnnotationAttributes
    ...
    CustomScanner rpcServiceScanner = new CustomScanner(beanDefinitionRegistry,
        RpcService.class);
    // Scan the Component annotation
    CustomScanner springBeanScanner = new CustomScanner(beanDefinitionRegistry,
        Component.class);
